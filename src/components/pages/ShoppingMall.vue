<template>
  <div>
    ...
    <!-- swiper area -->
    <swiperArea :bannerPicArray="bannerPicArray"/>
    <!--type bar-->
    <div class="type-bar">
...
import swiperArea from '../component/swiperArea'
import goodsInfo from '../component/goodsInfoComponent'
import {toMoney} from '@/filter/moneyFilters'
export default {
	data() {
		return {
			swiperOption: {
  ...
  components: { swiper, swiperSlide ,floorComponent,swiperArea,goodsInfo},
	created() {
		axios({
